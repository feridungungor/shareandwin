...
class withButton extends StatefulWidget {
  @override
  _withButtonState createState() => _withButtonState();
}

class _withButtonState extends State<withButton> with TickerProviderStateMixin{
  double sliderValue = 39;
  bool roone = false;
  AnimationController _controller;
  Animation<double> animation;
  double heightBegin = 200;
  double heightEnd = 350;
  ...
  void initState() {
    ...
    animation = Tween<double>(begin: heightBegin, end: heightEnd).animate(_controller);
  }
              ...
              Positioned(
                child: AnimatedBuilder(
                  builder: (context,anim){
                    return ClipPath(
                      clipper: myCustomClipper(OranOranti(animation.value, 200, 350, 50, 180)),
                      child: Container(
